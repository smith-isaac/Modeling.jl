...
function next_x(dss::DiscreteSS, x::Vector{Float64}, u::Float64)
    return dss.Ad * x + dss.Bd * u
end

function rk4(f::Function, x::Vector{Float64}, dt::Float64, params, u::Float64)
    k1 = f(x, params, u)
...
function rk4(ss::StateSpace, x::Vector{Float64}, dt::Float64, u::Float64)
    k1 = ss.A * x + ss.B * u
...
function eulers(f::Function, x::Vector{Float64}, dt::Float64, params, u::Float64)
    return f(x, params, u) * dt + x
end

function eulers(ss::StateSpace, x::Vector{Float64}, dt::Float64, u::Float64)
